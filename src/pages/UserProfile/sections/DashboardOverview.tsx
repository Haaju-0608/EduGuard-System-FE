...
export default function DashboardOverview({
  ...
  const quickActions: QuickAction[] = [
    ...
    },
    {
      ...
      action: () => onNavigate?.('/profile/attendance'),
    },
    {
      icon: '🔔',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[3fr_2fr] gap-5">
        ...
        <div className="bg-navy-card border border-border rounded-[20px] p-6">
          <div className="flex items-center justify-between mb-5">
            ...
            <span
              onClick={() => onNavigate?.('/profile/attendance')}
              className="text-xs text-blue-bright font-dm cursor-pointer hover:underline"
            >
              View all
            </span>
          </div>
