    ...
    <div className="bg-navy-card border border-border rounded-[16px] p-5 transition-all duration-300 hover:border-cyan/30 animate-fade-slide-in-3">
      <div className="flex items-center justify-between mb-5">
        ...
        <span
          ...
          className="text-xs text-cyan cursor-pointer hover:underline font-dm"
        >
          View All
        </span>
      </div>
  ...
  return (
    <div className="bg-navy-card border border-border rounded-[16px] p-5 transition-all duration-300 hover:border-cyan/30 animate-fade-slide-in-4">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-5">
        <h3 className="font-syne font-bold text-white-soft text-base">User Overview</h3>
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 animate-fade-slide-in-4">
      {actions.map((action) => (
        <button
          ...
          className={`flex items-center justify-center gap-2 rounded-xl py-3 font-semibold font-dm text-sm cursor-pointer transition-all duration-300 ${action.style} border-0`}
        >
...
export default function DashboardOverview({
  ...
  return (
    <div className="space-y-6">
      ...
      <UserManagementTable onNavigate={onNavigate} />
